  ...
  return (
    <ArticleLayout jsonLd={jsonLd}>
      ...
      <ArticleSection id="why-it-matters">
        ...
        <P>Graeber notes that throughout most of human history, the question of debt — who owes what to whom, and whether those debts are legitimate — has been a <em>political</em> question with no fixed answer. <a href="https://en.wikipedia.org/wiki/Debt_relief" target="_blank" rel="noopener noreferrer" className="underline decoration-gray-400 hover:decoration-gray-700">Debt cancellations and jubilees</a> happened repeatedly — in ancient Mesopotamia, in the Bible, across medieval Europe. The idea that debts are sacred and must always be paid in full is a story. A story that is very useful to the people you owe money to. Invented by them, repeated by them, taught in schools they fund. The same kind of story as the barter village: invented, useful to someone specific, repeated until it feels like nature.</P>
      </ArticleSection>
      ...
      <ArticleCallout variant="light" title="This Is the First Article in an Ongoing Series">
        <p>Each article in this series takes one foundational story — barter, banks, taxes, debt, land, work — and follows the actual record. Every time, the record tells a different story than the textbook. Every time, the textbook version turns out to serve someone specific. That&apos;s not a coincidence. That&apos;s the point.</p>
      </ArticleCallout>
