  ...
  return (
    <ArticleLayout jsonLd={jsonLd}>
      ...
      <ArticleSection id="graeber">
        ...
        <P>David Graeber spent decades as an anthropologist before writing <em>Debt: The First 5,000 Years</em> (2011). When he started researching the origin of money, he did something economists almost never do: he went to the anthropological record.</P>
      ...
      <ArticleSection id="politics">
        ...
        <P>This is what Karl Polanyi showed in <em>The Great Transformation</em> (1944). Polanyi documented in careful historical detail that the market economy was not a natural evolution. It was created, deliberately and violently, by states — through the enclosure of common lands, the destruction of traditional rights of access, the commodification of labor, land, and money, and the enforcement of a new legal and institutional order. Markets did not emerge spontaneously from human nature. They were constructed, with considerable effort and against considerable resistance.</P>
      ...
      <ArticleSection id="colonial">
        ...
        <P>The colonial solution was the <em>hut tax</em>. Starting in the 1890s across British, French, Belgian, and German colonies, indigenous households were required by law to pay an annual tax denominated in colonial currency. The hut tax had one purpose: to force people into the cash economy. If you had to pay taxes in colonial money, you had to earn colonial money, which meant you had to sell your labor to colonial employers.</P>
      ...
      <ArticleSection id="what-money-is">
        ...
        <P>The chartalist tradition of monetary theory — associated with economists like Warren Mosler, L. Randall Wray, and Stephanie Kelton — argues that money gets its value primarily from the fact that states accept it in payment of taxes. Because you must pay taxes in the national currency, and because the state will imprison you if you do not, the currency has a guaranteed floor of demand. Money is backed not by gold, not by barter convenience, but by the coercive authority of the state.</P>
      ...
      <ArticleSection id="why-it-matters">
        ...
        <P>Graeber notes that throughout most of human history, the question of debt — who owes what to whom, and whether those debts are legitimate — has been a <em>political</em> question. Debt cancellations, debt jubilees, the rewriting of monetary arrangements have happened repeatedly across history, from ancient Mesopotamia to medieval Europe. The idea that debts are sacred and must always be paid in full is ideology, not nature.</P>
      </ArticleSection>
