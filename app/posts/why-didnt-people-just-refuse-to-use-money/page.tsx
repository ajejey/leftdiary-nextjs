    ...
    <ArticleLayout jsonLd={jsonLd}>
      <ArticleHeader
        ...
        lead={
          <>
            ...
            medicine) run through money, when the thing that supposedly created money&rsquo;s power was
            one small, annual, avoidable demand?
          </>
        }
        date="July 4, 2026"
        dateTime="2026-07-04"
      ...
      <ArticleSection id="what-people-actually-had">
        ...
        <P>
          ...
          custom to be respected, but a privilege, granted or withheld entirely at the landowner&rsquo;s
      ...
      <ArticleSection id="money-that-demands-more-money-back">
        ...
        <P>
          ...
          that note stopped being honest. I think it is the single most important moment in
        ...
        <P>
          ...
          what their outstanding notes claimed, cash reserves as low as 10 percent of the
        ...
        <P>
          ...
          not &ldquo;John owes Sarah one.&rdquo; It isn&rsquo;t personal. Anyone can hold it, spend it, steal it.
      ...
      <ArticleSection id="who-was-actually-in-the-room">
        ...
        <P>
          ...
          was counted by land value, not by people, so a handful of large landowners could out-vote
          everyone else. The petition went to a Parliamentary committee of the same class of men
          who owned land just like it, which approved the bill and appointed commissioners, usually
          chosen by the petitioning landowners themselves, to survey the parish and hand out the
          newly enclosed plots.{' '}
        ...
        <P>
          ...
          offer anyone was your own body&rsquo;s effort, hour by hour. Whoever bought those hours
      ...
      <ArticleSection id="the-last-door">
        ...
        <P>
          ...
          classed as a surgical instrument. Women, barred from surgical practice by law, were
      ...
      <ArticleSection id="nobody-chose-this">
        ...
        <P>
          ...
          or your ancestors ever walked into voluntarily, but something built by closing every
          other exit, notice that this is only half of what I&rsquo;ve told you. The other half
          happened in London, in these same centuries: a handful of goldsmiths discovering they
          could create money that had never existed. Two separate developments, in two separate
      ...
      <ArticleCallout variant="dark" title="If the Market Was Never a Choice">
        <p>
          ...
          gravitated toward starts to look shakier. Whoever still holds the power to open or close
          a door like that, today, is not a passive referee. They are the same kind of actor the
          king, the Parliament, and the witch-hunting court once were. The next question is simply:
          who holds that power now, and what specific door are they closing while telling you it
          was always open.
        </p>
      </ArticleCallout>
